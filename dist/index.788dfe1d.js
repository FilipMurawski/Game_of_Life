...
})({"26vbG":[function(require,module,exports) {
...
var _gameInterface = require("./gameInterface");
async function mainGame() {
    const gameIF = new (0, _gameInterface.GameInterface)();
    gameIF.game.createGrid();
}
mainGame();

},{"./gameInterface":"hAF0y"}],"hAF0y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GameInterface", ()=>GameInterface);
...
class GameInterface {
    constructor(){
        ...
        this.game = new (0, _gameBoard.gameBoard)();
        this.interface = document.querySelector(".interface");
        this.modal = document.querySelector(".data-settings-modal");
        ...
        this.widthInput = document.getElementById("n-width");
        this.heightInput = document.getElementById("n-height");
    ...
    resetGameCallback = ()=>{
        ...
        for(let i = 0; i < cells.length; i++){
            const cell = cells[i];
            if (cell.classList.contains("alive")) cell.classList.remove("alive");
        }
    };
    startStopGameCallback = ()=>{
        console.log(this.startStopGameButton);
        if (this.gameState === "stop") this.gameState = "running";
        else this.gameState = "stop";
        this.runGame();
    };
    // updateFPS = () => {
    //     this.frameCount++;
...
},{"./gameBoard":"idqp6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"idqp6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class gameBoard {
    constructor(height = 50, width = 50){
        ...
        this.width = width;
        this.doc = document;
        this.board = this.doc.querySelector(".gameBoard__gridContainer");
        this.grid = [];
    ...
    countLiveNeighbors = (row, col)=>{
        ...
        for(let i = -1; i <= 1; i++)for(let j = -1; j <= 1; j++){
            ...
            if (neighborCell && neighborCell.classList.contains("alive")) count++;
        }
        return count;
    };
    evolveGrid = ()=>{
        ...
        for(let i = 0; i < this.cells.length; i++){
            ...
            const aliveN = this.countLiveNeighbors(row, col);
            const elem = {
                element: cell,
                liveNeighbors: aliveN
            };
            cellsAndAlive.push(elem);
        }
        console.log(cellsAndAlive);
        for(let i = 0; i < cellsAndAlive.length; i++){
            const cell = cellsAndAlive[i].element;
            const liveNeighbors = cellsAndAlive[i].liveNeighbors;
            if (cell !== undefined && cell.classList.contains("alive")) {
                if (liveNeighbors < 2 || liveNeighbors > 3) cell.classList.remove("alive");
            } else if (liveNeighbors === 3) cell.classList.add("alive");
        }
    };
}
...
},{}]},["26vbG","45gvb"], "45gvb", "parcelRequire716c")

//# sourceMappingURL=index.788dfe1d.js.map
